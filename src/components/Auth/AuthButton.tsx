...
export const AuthButton = ({ showDropdown = true }: AuthButtonProps) => {
            ...
            {isAuthenticated ? (
              <>
                ...
                <div className="py-2">
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-left"
                  >
              ...
              <div className="p-4">
                <div className="text-center mb-4">
                  ...
                  <h3 className="font-semibold dark:text-white mb-1">Welcome to ModernStore</h3>
                ...
                <div className="mt-4 text-center text-sm">
                  ...
                  <button
                    onClick={() => {
                      handleLogin();
                      alert('This is a demo version. In production, this would open a registration form.');
                    }}
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => {
                        handleLogin();
                        alert('This is a demo version. Google login would be implemented in production.');
                      }}
                    ...
                    <button
                      onClick={() => {
                        handleLogin();
                        alert('This is a demo version. Facebook login would be implemented in production.');
                      }}
                      className="flex-1 flex items-center justify-center gap-2 py-2 px-3 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                    >
